...
/**
 * Hero card for the word of the day. Adapts shape and copy from the
 * design's WordOfDayCard while pulling content from the live word object.
 */
const WordOfDayCard = ({ word }) => {
    ...
    >
      <div>
        ...
        <div className="mt-3 flex items-center gap-3 flex-wrap">
          {word.pronunciation && (
            <span className="kd-font-mono" style={{ fontSize: 15, color: 'var(--kd-ink-soft)' }}>
              /{word.pronunciation}/
            </span>
          )}
          {word.part_of_speech && (
          ...
          <>
            ...
            {exampleTr && (
              <p
                ...
                style={{ fontSize: 15, color: 'var(--kd-ink-soft)', lineHeight: 1.5, margin: 0 }}
              >
                {exampleTr}
              </p>
            )}
