...
const make = (paths, defaultSize = 18) => ({ size = defaultSize, weight, fill, color, ...rest }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconSpeaker = make(<><path d="M11 5 6 9H3v6h3l5 4z" /><path d="M16 8c2 1.5 2 6.5 0 8" /><path d="M19 5c3 3 3 11 0 14" /></>);
export const IconBookmark = make(<path d="M6 4h12v17l-6-4-6 4z" />);
export const IconHeart = make(<path d="M12 20s-7-4.5-7-10a4 4 0 0 1 7-2.5A4 4 0 0 1 19 10c0 5.5-7 10-7 10z" />);
export const IconShare = make(<><path d="M12 3v13" /><path d="m7 8 5-5 5 5" /><path d="M5 13v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6" /></>);
export const IconArrow = make(<><path d="M5 12h14" /><path d="m13 6 6 6-6 6" /></>);
export const IconBack = make(<><path d="M19 12H5" /><path d="m11 18-6-6 6-6" /></>);
...
export const IconGlobe = make(<><circle cx="12" cy="12" r="9" /><path d="M3 12h18" /><path d="M12 3a14 14 0 0 1 0 18a14 14 0 0 1 0-18" /></>);
export const IconPlay = ({ size = 16, color }) => (
