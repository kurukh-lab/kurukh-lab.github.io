    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-2xl">
        ...
        <p className="py-2 text-sm text-gray-600">
          Help improve the dictionary by suggesting corrections for:{' '}
          <span className="font-medium text-primary">{wordText}</span>
        </p>
        ...
        {!currentUser ? (
          ...
          <div className="alert alert-success mt-4">
            ...
            <span>
              Thank you! Your correction has been submitted and will be reviewed by the community.
            </span>
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            ...
            <div className="alert alert-info mt-4 text-sm">
              ...
              <span>
                Your correction will be marked for community review. Both admins and experienced
                users can review and approve it.
              </span>
            </div>
